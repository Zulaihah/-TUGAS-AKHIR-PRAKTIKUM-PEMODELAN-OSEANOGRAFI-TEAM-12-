...
Persamaan adveksi 1 dimensi yang digunakan :
 ...
 (1)Persamaan difusi 1 dimensi yang digunakan :
 
2
 (2)Persamaan adveksi - difusi 1 dimensi yang digunakan :
 x f  Ad  x f U t  f 

2
 (3)Dimana f menggambarkan konsentrasi suatu zat terlarut, U adalah koefisienadveksi, dan Ad adalah koefisien difusi, dan x adalah arah sumbu horisontal.
